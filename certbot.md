...
ssh -p 22 holly@45.32.84.228

http://blog.51cto.com/favccxx/1622091
http://www.hawu.me/operation/852#22
...
```bash
certbot -a dns-plugin -i nginx  -w /var/www -d "*.javajs.cc" -d javajs.cc --server https://acme-v02.api.letsencrypt.org/directory
```

```bash
certbot certonly  --standalone --preferred-challenges http -w /var/www -d "*.javajs.cc" -d javajs.cc --server https://acme-v02.api.letsencrypt.org/directory
```

https://github.com/Neilpang/acme.sh
```
acme.sh --issue -d javajs.tk -d javajs.cc --dns \
 --yes-I-know-dns-manual-mode-enough-go-ahead-please
```


```
acme.sh --renew  -d javajs.tk -d javajs.cc \
  --yes-I-know-dns-manual-mode-enough-go-ahead-please
```


```bash
certbot -a dns-plugin -i nginx  -w /var/www -d "*.javajs.cc" -d javajs.cc -d "*.javajs.tk" -d javajs.tk --server https://acme-v02.api.letsencrypt.org/directory
```

```
[root@us-vultr holly]# certbot --help all
usage: 
